...
const UnshSignUp = () => {
    return (
        <div className="h-screen w-screen flex flex-col justify-center items-center bg-sky-400">
            <div className="bg-white p-6 w-96">
                <from>
                    <h3 className="text-2xl font-semibold text-center mb-6"> User Sign Up</h3>
                    ...
                    <p className="forgot-password text-center p-3">
                        Already registered <a className="text-blue-500" href="">sign in?</a>
                    </p>
