const TopCard = () => {
  return (
    ...
    // <div className="grid grid-flow-col m-40 pr-96">

    <div className="overflow-hidden rounded-lg border border-gray-100 shadow-sm dark:border-gray-800 dark:shadow-gray-700/25">
      <img
        alt="Office"
